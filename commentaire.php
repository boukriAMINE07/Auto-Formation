...
if (isset($_POST['okey'])){
    $des=$_POST['des'];
    $cmt=mysqli_real_escape_string($con,$_POST['comment']);
    $idEt=$_SESSION['IDETUDIANT'];

    $date=date("Y-m-d");

    $sql= "INSERT INTO commentaires VALUES ('','$cmt','$date', $idEt,$des)";       
    mysqli_query($con,$sql);

    header("Location: http://127.0.0.1/study/index.php?com");
}
?>
...
<head>
  ...
  <title>EMSI.CASA | Commentaire</title>
	...
	<div class="container">
		<div class="row">
			...
			<div class="contact-form col-md-6 " >
				<form  method="post"  >
                    <h2 class="contact-details col-md-6" >Votre commentaire</h2>
					...
					<div class="form-group">
						<?php
                            ...
                            $sql="select * from langages ";
                            echo"<select name=des  class=\"form-control\" placeholder=\"votre adresse email \"  required>";
					...
					<div class="form-group">
						<textarea rows="8" placeholder="Your Comment" class="form-control" name="comment" id="message"  required></textarea>	
					...
					<div id="cf-submit">
           <button type="submit" id="contact-submit" name="okey" class="btn btn-transparent">Submit</button>
					</div>						
					<script>
            var div = $('<div/>');
