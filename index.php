 ...
 <section class="hero-area">
 	<div class="container">
 		<div class="row">
 			<div class="col-md-12">
 				<div class="block">
 					<h1  class="wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".3s">Un apprentissage  <br>qui vous ressemble</h1>
 					<p class="wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".5s">
					<strong>Des compétences pour aujourd'hui (et demain). Nous vous accompagnons dans vos premiers pas.</strong>	
 					</p>
					 <br><br><br>
					 <p class="wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".5s">
							<h4><strong>Formation Gratuit introduit Par EMSI.CASA</strong> </h4>
 					<ul class="list-inline wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".7s">
 						<li class="list-inline-item">
 							<a data-scroll href="blog.php" class="btn btn-main">Learn more </a>
 						</li>
						 <?php
							
							if (!isset($_SESSION['IDETUDIANT'])) {
								echo "<li class=\"list-inline-item\">
								<a data-scroll href=\"connexion.php\" class=\"btn btn-transparent\">Connexion </a>
							</li>";
							}
    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <div class="title text-center">
          ...
          <h2 style="color:#28ABE3;">
				 <strong>EMSI<a href="index.php" style="color:#000;">
				 <span>.CASA</span></strong></h2>
      ...
      <div class="col-md-12">
		...
		<h3>Nos langages de Programmation <div class="border"></div> </h3>
		
        <p>le site web EMSI.CASA présente Le langage de programmation des pages Web de programmation,En langage populaire,Un langage d'accès aux bases de données et un langage de programmation de serveur Web</p>
      </div>
      </div>
      <br><br>
      <?php
	    $sql="select idlangage,logolangage,designationlangage from langages  ";
		$query=mysqli_query($con,$sql);
		while ($tab=mysqli_fetch_assoc($query)) {
			echo "
		  ...
		  <div class=\"row text-center\">
			 ...
			 <a href='index.php?cours={$tab['idlangage']}'> <img width=240 style=\"border-radius: 100%; \" src=\"{$tab['logolangage']}\" >
				 <h5>{$tab['designationlangage']}</h5>
				 <p>Voir le cours</p></a>
			...
			<div class="row">	
				...
				<div class="col-lg-12">
					...
					<div class="testimonial-slider">
						...
						<?php
					$sql="select * from etudiants natural join commentaires natural join langages order by DateCommentaire ";
					$query=mysqli_query($con,$sql);
					...
					echo "
						...
						<div class=\"item text-center\">
							...
							<div class=\"client-details\">
								<p>".substr($tab['commentaire'],0,300)."</p>
							</div>
							<!-- /client info -->
							<!-- client photo -->
							<div class=\"client-thumb\">
								<img src='{$tab['logolangage']}' class=\"img-fluid\" alt=\"\">
							</div>
							<div class=\"client-meta\">
								<h3>{$tab['NOM']} {$tab['PRENOM']}</h3>
							</div>
							<!-- /client photo -->
						</div>
						<!-- /testimonial single -->
			...
			<article class=\"col-md-4 col-sm-6 col-xs-12 clearfix \">
				<div class=\"post-item\">
					...
					<div class=\"content\">
						...
						<a class=\"btn btn-main\" href=\"blog.php\">Read more</a>
					</div>
				</div>
			</article>
			";
