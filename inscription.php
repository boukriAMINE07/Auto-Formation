...
include('cnx.php');
if(isset($_POST['ok'])){
  $query=mysqli_query($con," select * from etudiants where emailEtudiant='{$_POST['email']}'");
  $count=mysqli_num_rows($query);
    if($count ==1){
      ...
      $pass=mysqli_real_escape_string($con,$_POST['mpass']);
      $dateN=mysqli_real_escape_string($con,$_POST['dateN']);
      $pays=mysqli_real_escape_string($con,$_POST['pays']);
      $dateIn=date("Y-m-d");
           
      $sql= "INSERT INTO etudiants (IDETUDIANT,NOM,PRENOM,DATENAISSANCE,PAYE,DATEINSCRIPTION,	ETAT,emailEtudiant,	motpasse) VALUES ('','$nom','$prenom','$dateN','$pays','$dateIn',1,'$email','$pass')";     
      ...
      mysqli_query($con,$sql);
        ...
        header("location: http://127.0.0.1/study/connexion.php");
...
if (isset($_GET['c'])) {
  if (isset($_SESSION['IDETUDIANT'])) {
    ...
    echo "
    <script>
    alert(\"Il faut être d'abord connecté\")
...
<head>
  ...
  <title>EMSI.CASA | Inscription</title>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        ...
        <li class="nav-item ">
          ...
          <li class="nav-item dropdown active">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" onclick="window.location.href = 'blog.php';" 
			...
			<div class="contact-form col-md-6 " >
				<form  method="post">
					<div class="form-group">
						<input type="text" placeholder="Votre Nom" class="form-control" name="nom" id="name">
					</div>
          <div class="form-group">
          	<input type="text" placeholder="Votre Prenom" class="form-control" name="prenom" id="name">
          </div>
					...
					<div class="form-group">
          	<input type="text" placeholder="Votre Pays" class="form-control" name="pays" id="name">
          </div>
					
          <div class="form-group">
          	<input type="text" placeholder="Votre date de naissance" onfocus="(this.type='date')" class="form-control" name="dateN" id="date">
          </div>
